...
@contextmanager
def trace_txt_saving(
    label: str, orig_stream: LineStream
) -> Generator[LineStream, None, None]:
...
@contextmanager
def trace_py_saving(
    label: str, TT: type[TraceTranslator]
) -> Generator[type[TraceTranslator], None, None]:
...
@contextmanager
def model_trace_py_saving(
    label: str, MT: type[ModelTraceInterpreter]
) -> Generator[type[ModelTraceInterpreter], None, None]:
