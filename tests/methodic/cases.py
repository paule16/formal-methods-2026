...
for acl_case in acl_cases:
    acl_entries, caller_user, caller_group, object_user, object_group = (
        compute_acl_case(acl_case)
    )
    acl_cases_grouped[(caller_user, caller_group)].append(
        (acl_case, acl_entries, object_user, object_group)
    )
