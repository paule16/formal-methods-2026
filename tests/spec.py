...
class ProgramMaker(Protocol):
    ...
    def bound_value_as_charparray(
        self, init: Any = None, prefix: str = "args"
    ) -> Any: ...

    def bound_value_as_chararray(
        self, size: Any, init: Any = None, prefix: str = "buf"
    ) -> Any: ...
    ...
    def open(
        self, pathname: str, flags: int, mode: int, fatal: bool = False
    ) -> Any: ...

    def openat(
        self, dirfd: Any, pathname: str, flags: int, mode: int, fatal: bool = False
    ) -> Any: ...
    ...
    def execve(
        self, exeFile: Any, argv: Any, envp: Any, fatal: bool = False
    ) -> Any: ...
...
class LinuxTestSpec(Protocol):
    def make_user(
        self, user: str, supplementary_groups: Optional[list[str]] = None
    ) -> None: ...
