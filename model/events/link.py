...
def link(
    ...
    _newName: Machine.StringsItem | None,
) -> Event:
    ...
    _grd2 = Guard("grd2", lambda _: _(2, (~oldParent) in m.Folders))

    _grd3 = Guard("grd3", lambda _: _(3, (~newParent) in m.Folders))

    _grd4 = Guard("grd4", lambda _: _(4, (~file) in (m.Files - m.Folders)))

    _grd5 = Guard(
        "grd5", lambda _: _(5, ((~file), ((~oldParent), (~oldName))) in m.FileParents)
    )

    _grd6 = Guard(
        "grd6",
        lambda _: _(6, ((~newParent), (~newName)) not in relation_range(m.FileParents)),
    )
    ...
    _grd7 = Guard(
        ...
        lambda _: _(
            ...
            not any(
                True
                for f in (
                    function_value(m.PathToRoot, (~oldParent))
                    | frozenset(((~oldParent),))
                )
    ...
    _grd8 = Guard(
        ...
        lambda _: _(
            ...
            not any(
                True
                for f in function_value(m.PathToRoot, (~newParent))
                if function_value(m.ProcUser, (~proc)) != m.ROOT_USER
                if not (
                    (
                        (
    ...
    _grd9 = Guard(
        "grd9",
        lambda _: (
            not (_(9, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                (
                    (
                        (
                                ...
                                (
                                    (
                                        _(
                                            10,
                                            function_value(m.ProcUser, (~proc))
                                            == function_value(m.FileUser, (~newParent)),
                                        )
                                    )
                                    and (
                                        _(
                            ...
                            or (
                                ...
                                and (
                                    _(
                                        ...
                                        <= function_value(m.MaskACL, (~newParent)),
                                    )
                                )
                            )
                        )
                        or (
                            (
                                ...
                                and (_(25, (~newParent) in relation_domain(m.MaskACL)))
                            )
                            and (
                                _(
                                    26,
                    ...
                    or (
                        (
                            (
                                ...
                                and (
                                    _(
                                        28,
                                        (~newParent) not in relation_domain(m.MaskACL),
                                    )
                                )
                            )
                            and (
                                (
                                    _(
                                        29,
                                        function_value(m.FileGroup, (~newParent))
                                        == function_value(m.ProcGroup, (~proc)),
                                    )
                                )
                                or (
                        ...
                        and (
                            _(
                                31,
                                frozenset((m.GWRITE, m.GEXECUTE))
                                <= function_value(m.DACPermissions, (~newParent)),
                            )
                        )
                    )
                )
                    ...
                    (
                        ...
                        or (
                            (
                                ...
                                and (_(56, (~file) in relation_domain(m.MaskACL)))
                            )
                            and (
                                _(
                                    57,
                    ...
                    or (
                        (
                            (
                                ...
                                and (_(59, (~file) not in relation_domain(m.MaskACL)))
                            )
                            and (
                                (
                                    _(
    ...
    _grd11 = Guard(
        "grd11",
        lambda _: (
            not (_(71, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                _(
                    72,
                    not any(
    ...
    _grd12 = Guard(
        "grd12",
        lambda _: (
            not (_(73, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                _(
                    74,
                    not any(
                        True
                        for f in (
                            function_value(m.PathToRoot, (~newParent))
                            | frozenset(((~newParent),))
                        )
                        if not (
                            not (function_value(m.ProcLabel, (~proc)) == m.STAR)
    ...
    _grd13 = Guard(
        ...
        lambda _: (
            ...
            or (
                (not (_(76, function_value(m.ProcLabel, (~proc)) == m.STAR)))
                and (
                    (
                        (_(77, function_value(m.FileLabel, (~newParent)) == m.STAR))
                        or (
                            _(
                                78,
                                function_value(m.ProcLabel, (~proc))
                                == function_value(m.FileLabel, (~newParent)),
                            )
                        )
                    )
                    or (
        ...
        lambda _: (
            not (
                _(
                    ...
                    function_value(m.ProcUser, (~proc))
                    not in frozenset(
                        (function_value(m.FileUser, (~file)), m.ROOT_USER)
                    ),
                )
            )
            or (
                (not (_(81, function_value(m.ProcLabel, (~proc)) == m.STAR)))
                and (
                    (
                        (
                            (
                                (_(82, function_value(m.ProcLabel, (~proc)) == m.HAT))
                                or (
                                    _(
                                        83,
                            ...
                            or (_(84, function_value(m.FileLabel, (~file)) == m.STAR))
                        )
                        or (
                            _(
                                85,
    ...
    _grd15 = Guard(
        ...
        lambda _: (
            ...
            or (
                (not (_(88, function_value(m.ProcLabel, (~proc)) == m.STAR)))
                and (
                    (
                        (_(89, function_value(m.FileLabel, (~file)) == m.STAR))
                        or (
                            _(
                                90,
                                function_value(m.ProcLabel, (~proc))
    ...
    _act1 = Action(
        ...
        m,
        "FileParents",
        lambda: m.FileParents | frozenset((((~file), ((~newParent), (~newName))),)),
    )
