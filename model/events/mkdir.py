...
def mkdir(
    ...
    _newTransmute: frozenset[Machine.FilesItem] | None,
) -> Event:
    ...
    _grd3 = Guard(
        "grd3",
        lambda _: _(3, (~folder) in ((m.FILES - m.Files) - relation_range(m.FDFile))),
    )
    ...
    _grd5 = Guard("grd5", lambda _: _(5, (~mode) <= m.PERMISSIONS))

    _grd6 = Guard("grd6", lambda _: _(6, (~group) in m.Groups))

    _grd7 = Guard("grd7", lambda _: _(7, len(m.Files) < m.MAX_FILES))
    ...
    _grd8 = Guard(
        ...
        lambda _: _(
            8,
            not any(
                True for p in m.Procs if not (function_value(m.ProcEXE, p) != (~folder))
            ),
        ),
    )
    ...
    _grd9 = Guard(
        "grd9",
        lambda _: (
            not (_(9, m.SET_GID not in function_value(m.DACPermissions, (~parent))))
            or (_(10, (~group) == function_value(m.ProcGroup, (~proc))))
        ),
    )
    ...
    _grd10 = Guard(
        "grd10",
        lambda _: (
            not (_(11, m.SET_GID in function_value(m.DACPermissions, (~parent))))
            or (_(12, (~group) == function_value(m.FileGroup, (~parent))))
        ),
    )
    ...
    _grd12 = Guard(
        "grd12",
        lambda _: (
            not (_(14, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                (
                    (
                        (
                        ...
                        or (
                            (
                                ...
                                and (_(30, (~parent) in relation_domain(m.MaskACL)))
                            )
                            and (
                                _(
                                    31,
                    ...
                    or (
                        (
                            (
                                ...
                                and (_(33, (~parent) not in relation_domain(m.MaskACL)))
                            )
                            and (
                                (
                                    _(
    ...
    _grd13 = Guard(
        ...
        lambda _: _(
            ...
            == (
                ...
                - ((~mode) & function_value(m.ProcUmask, (~proc)))
            ),
        ),
    )
    ...
    _grd14 = Guard(
        "grd14",
        lambda _: (
            not (_(46, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                _(
                    47,
                    not any(
    ...
    _grd15 = Guard(
        "grd15",
        lambda _: (
            not (_(48, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                (not (_(49, function_value(m.ProcLabel, (~proc)) == m.STAR)))
                and (
                    (
                        (_(50, function_value(m.FileLabel, (~parent)) == m.STAR))
                        or (
                            _(
                                51,
                                function_value(m.ProcLabel, (~proc))
    ...
    _grd16 = Guard("grd16", lambda _: _(53, (~newTransmute) <= m.FILES))
    ...
    _grd17 = Guard(
        ...
        lambda _: (
            (
                (
                    (
                        (_(54, (~parent) in m.TransmuteFolders))
                        and (
                            _(
                                55,
                                m.TRANSMUTE
                    ...
                    and (_(56, (~fileLabel) == function_value(m.FileLabel, (~parent))))
                )
                and (_(57, (~newTransmute) == frozenset(((~folder),))))
            )
            or (
                (_(58, (~fileLabel) == function_value(m.ProcLabel, (~proc))))
                and (_(59, len((~newTransmute)) == 0))
            )
        ),
    )
    ...
    _act5 = Action(
        ...
        "DACPermissions",
        lambda: override_relation(
            m.DACPermissions, frozenset((((~folder), (~perms)),))
        ),
    )
    ...
    _act6 = Action(
        ...
        "FileUser",
        lambda: override_relation(
            m.FileUser, frozenset((((~folder), function_value(m.ProcUser, (~proc))),))
        ),
    )
    ...
    _act7 = Action(
        ...
        m,
        "FileGroup",
        lambda: override_relation(m.FileGroup, frozenset((((~folder), (~group)),))),
    )
        ...
        lambda: override_relation(
            ...
            frozenset(
                (
                    (
                        (~folder),
                        frozenset[tuple[Machine.StringsItem, Machine.DataItem]](),
                    ),
                )
            ),
        ),
    ...
    _act9 = Action(
        ...
        "GroupObjACL",
        lambda: (
            m.GroupObjACL | frozenset((((~folder), ((~perms) & m.GROUP_PERMISSIONS)),))
        ),
    )
    ...
    _act10 = Action(
        ...
        m,
        "FileLabel",
        lambda: override_relation(m.FileLabel, frozenset((((~folder), (~fileLabel)),))),
    )

    _act11 = Action(
        "act11", m, "TransmuteFolders", lambda: m.TransmuteFolders | (~newTransmute)
    )
