...
def open_exists(
    ...
    _grd21 = Guard(
        ...
        lambda _: (
            not (
                (_(132, m.O_DIRECTORY in (~flags)))
                and (_(133, m.O_PATH not in (~flags)))
            )
            or (_(134, m.O_CREAT not in (~flags)))
        ),
    )
    ...
    _grd22 = Guard(
        "grd22",
        lambda _: (
            not ((_(135, m.O_PATH not in (~flags))) and (_(136, m.O_CREAT in (~flags))))
            or (_(137, (~file) not in m.Folders))
        ),
    )
    ...
    _grd24 = Guard(
        "grd24",
        lambda _: (
            not (_(138, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                _(
                    139,
                    not any(
    ...
    _grd25 = Guard(
        ...
        lambda _: (
            not (
                (
                    (_(140, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
                    and (
                        (_(141, m.O_RDONLY in (~flags)))
                        or (_(142, m.O_RDWR in (~flags)))
                    )
                )
                and (_(143, m.O_PATH not in (~flags)))
            )
            or (
                (not (_(144, function_value(m.ProcLabel, (~proc)) == m.STAR)))
                and (
                    (
                        (
                            (
                                (_(145, function_value(m.ProcLabel, (~proc)) == m.HAT))
                                or (
                                    _(
                                        146,
                            ...
                            or (_(147, function_value(m.FileLabel, (~file)) == m.STAR))
                        )
                        or (
                            _(
                                148,
    ...
    _grd26 = Guard(
        ...
        lambda _: (
            not (
                (
                    (_(150, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
                    and (
                        (_(151, m.O_WRONLY in (~flags)))
                        or (_(152, m.O_RDWR in (~flags)))
                    )
                )
                and (_(153, m.O_PATH not in (~flags)))
            )
            or (
                (not (_(154, function_value(m.ProcLabel, (~proc)) == m.STAR)))
                and (
                    (
                        (_(155, function_value(m.FileLabel, (~file)) == m.STAR))
                        or (
                            _(
                                156,
                                function_value(m.ProcLabel, (~proc))
