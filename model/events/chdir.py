...
def chdir(
    m: Machine, _proc: Machine.ProcsItem | None, _dir: Machine.FilesItem | None
) -> Event:
    ...
    _grd2 = Guard("grd2", lambda _: _(2, (~dir) in m.Folders))
    ...
    _grd3 = Guard(
        ...
        lambda _: _(
            ...
            not any(
                True
                for f in (function_value(m.PathToRoot, (~dir)) | frozenset(((~dir),)))
            ...
            or (
                _(
                    ...
                    not any(
                        True
                        for f in (
                            function_value(m.PathToRoot, (~dir)) | frozenset(((~dir),))
                        )
                        if not (
    ...
    _act1 = Action(
        ...
        m,
        "ProcCwd",
        lambda: override_relation(m.ProcCwd, frozenset((((~proc), (~dir)),))),
    )
