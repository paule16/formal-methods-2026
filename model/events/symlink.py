...
def symlink(m: Machine,
    ...
    ((~parent), (~name)) not in relation_range(m.FileParents))))
    ...
    _grd8 = Guard('grd8', lambda _: (not (_(8, 
    function_value(m.ProcUser, (~proc)) != m.ROOT_USER)) or (((((((_(9, 
    function_value(m.ProcUser, (~proc)) == function_value(m.FileUser, (~parent)))) and (_(10, 
    frozenset((m.UWRITE, m.UEXECUTE)) <= function_value(m.DACPermissions, (~parent))))) or (((((_(11, 
    function_value(m.ProcUser, (~proc)) != function_value(m.FileUser, (~parent)))) and ((_(12, 
    (~parent) not in relation_domain(m.MaskACL))) or (_(13, len(function_value(m.MaskACL, (~parent))) == 0)))) and (_(14, 
    function_value(m.FileGroup, (~parent)) != function_value(m.ProcGroup, (~proc))))) and (_(15, (function_value(m.ProcUser, (~proc)), function_value(m.FileGroup, (~parent))) not in m.UserGroups))) and (_(16, 
    frozenset((m.OWRITE, m.OEXECUTE)) <= function_value(m.DACPermissions, (~parent)))))) or ((((_(17, 
    function_value(m.ProcUser, (~proc)) != function_value(m.FileUser, (~parent)))) and (_(18, 
    ((~parent), function_value(m.ProcUser, (~proc))) in relation_domain(m.UserACL)))) and (_(19, frozenset((m.UWRITE, m.UEXECUTE)) <= function_value(m.UserACL, ((~parent), function_value(m.ProcUser, (~proc))))))) and (_(20, 
    frozenset((m.GWRITE, m.GEXECUTE)) <= function_value(m.MaskACL, (~parent)))))) or (((((_(21, 
    function_value(m.ProcUser, (~proc)) != function_value(m.FileUser, (~parent)))) and (_(22, 
    ((~parent), function_value(m.ProcUser, (~proc))) not in relation_domain(m.UserACL)))) and (_(23, 
    any (True for g in (frozenset((function_value(m.ProcGroup, (~proc)),)) | relation_image(m.UserGroups, frozenset((function_value(m.ProcUser, (~proc)),)))) if 
    (((~parent), g) in relation_domain(m.GroupACL) and frozenset((m.GWRITE, m.GEXECUTE)) <= function_value(m.GroupACL, ((~parent), g)) or g == function_value(m.FileGroup, (~parent)) and (~parent) in relation_domain(m.GroupObjACL) and frozenset((m.GWRITE, m.GEXECUTE)) <= function_value(m.GroupObjACL, (~parent))))))) and (_(24, 
    (~parent) in relation_domain(m.MaskACL)))) and (_(25, frozenset((m.GWRITE, m.GEXECUTE)) <= function_value(m.MaskACL, (~parent)))))) or ((((_(26, 
    function_value(m.ProcUser, (~proc)) != function_value(m.FileUser, (~parent)))) and (_(27, 
    (~parent) not in relation_domain(m.MaskACL)))) and ((_(28, 
    function_value(m.FileGroup, (~parent)) == function_value(m.ProcGroup, (~proc)))) or (_(29, (function_value(m.ProcUser, (~proc)), function_value(m.FileGroup, (~parent))) in m.UserGroups)))) and (_(30, 
    frozenset((m.GWRITE, m.GEXECUTE)) <= function_value(m.DACPermissions, (~parent)))))) or ((((((((_(31, 
    function_value(m.ProcUser, (~proc)) != function_value(m.FileUser, (~parent)))) and (_(32, 
    (~parent) in relation_domain(m.MaskACL)))) and (_(33, len(function_value(m.MaskACL, (~parent))) != 0))) and (_(34, 
    ((~parent), function_value(m.ProcUser, (~proc))) not in relation_domain(m.UserACL)))) and (_(35, 
    not any (True for g in (frozenset((function_value(m.ProcGroup, (~proc)),)) | relation_image(m.UserGroups, frozenset((function_value(m.ProcUser, (~proc)),)))) if not (
    ...
    _grd9 = Guard('grd9', lambda _: (_(39, 
    len(m.Files) < m.MAX_FILES)))

    _grd10 = Guard('grd10', lambda _: (not (_(40, function_value(m.ProcUser, (~proc)) != m.ROOT_USER)) or (_(41, 
    ...
    _grd11 = Guard('grd11', lambda _: (not (_(42, 
    function_value(m.ProcUser, (~proc)) != m.ROOT_USER)) or ((not (_(43, 
    function_value(m.ProcLabel, (~proc)) == m.STAR))) and (((_(44, 
    function_value(m.FileLabel, (~parent)) == m.STAR)) or (_(45, 
    function_value(m.ProcLabel, (~proc)) == function_value(m.FileLabel, (~parent))))) or (_(46, 
    ...
    _act10 = Action('act10', m, 'FileLabel', lambda: (override_relation(m.FileLabel, frozenset((((~file), function_value(m.ProcLabel, (~proc))),)))))


    return Event("symlink", _grd1, _grd2, _grd3, _grd4, _grd5, _grd6, _grd7, _grd8, _grd9, _grd10, _grd11, _act1, _act2, _act3, _act4, _act5, _act6, _act7, _act8, _act9, _act10)
