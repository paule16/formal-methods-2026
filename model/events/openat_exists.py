...
def openat_exists(
    ...
    _grd26 = Guard(
        ...
        lambda _: (
            not (
                (_(140, m.O_DIRECTORY in (~flags)))
                and (_(141, m.O_PATH not in (~flags)))
            )
            or (_(142, m.O_CREAT not in (~flags)))
        ),
    )
    ...
    _grd27 = Guard(
        "grd27",
        lambda _: (
            not ((_(143, m.O_PATH not in (~flags))) and (_(144, m.O_CREAT in (~flags))))
            or (_(145, (~file) not in m.Folders))
        ),
    )
    ...
    _grd28 = Guard(
        "grd28",
        lambda _: (
            not (_(146, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                _(
                    147,
                    not any(
    ...
    _grd29 = Guard(
        ...
        lambda _: (
            not (
                (
                    (_(148, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
                    and (
                        (_(149, m.O_RDONLY in (~flags)))
                        or (_(150, m.O_RDWR in (~flags)))
                    )
                )
                and (_(151, m.O_PATH not in (~flags)))
            )
            or (
                (not (_(152, function_value(m.ProcLabel, (~proc)) == m.STAR)))
                and (
                    (
                        (
                            (
                                (_(153, function_value(m.ProcLabel, (~proc)) == m.HAT))
                                or (
                                    _(
                                        154,
                            ...
                            or (_(155, function_value(m.FileLabel, (~file)) == m.STAR))
                        )
                        or (
                            _(
                                156,
    ...
    _grd30 = Guard(
        ...
        lambda _: (
            not (
                (
                    (_(158, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
                    and (
                        (_(159, m.O_WRONLY in (~flags)))
                        or (_(160, m.O_RDWR in (~flags)))
                    )
                )
                and (_(161, m.O_PATH not in (~flags)))
            )
            or (
                (not (_(162, function_value(m.ProcLabel, (~proc)) == m.STAR)))
                and (
                    (
                        (_(163, function_value(m.FileLabel, (~file)) == m.STAR))
                        or (
                            _(
                                164,
                                function_value(m.ProcLabel, (~proc))
