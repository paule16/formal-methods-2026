...
def chown(m: Machine,
    ...
    _grd12 = Guard('grd12', lambda _: (not (_(20, function_value(m.ProcUser, (~proc)) != m.ROOT_USER)) or (_(21, 
    ...
    return Event("chown", _grd1, _grd2, _grd3, _grd4, _grd5, _grd6, _grd7, _grd8, _grd9, _grd10, _grd11, _grd12, _act1, _act2, _act3)
