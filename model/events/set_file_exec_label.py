...
def set_file_exec_label(m: Machine,
                        ...
                        _label: Machine.StringsItem | None) -> Event:
    ...
    _act1 = Action('act1', m, 'FileExecLabel', lambda: (override_relation(m.FileExecLabel, frozenset((((~file), (~label)),)))))


    return Event("set_file_exec_label", _grd1, _grd2, _act1)
