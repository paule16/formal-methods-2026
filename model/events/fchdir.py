...
def fchdir(m: Machine,
    ...
    _grd5 = Guard('grd5', lambda _: (not (_(35, function_value(m.ProcUser, (~proc)) != m.ROOT_USER)) or ((not (_(36, 
    function_value(m.ProcLabel, (~proc)) == m.STAR))) and (((((_(37, 
    function_value(m.ProcLabel, (~proc)) == m.HAT)) or (_(38, 
    function_value(m.FileLabel, function_value(m.FDFile, (~fd))) == m.FLOOR))) or (_(39, 
    function_value(m.FileLabel, function_value(m.FDFile, (~fd))) == m.STAR))) or (_(40, 
    function_value(m.ProcLabel, (~proc)) == function_value(m.FileLabel, function_value(m.FDFile, (~fd)))))) or (_(41, 
    m.EXECUTE in relation_image(m.SmackRules, frozenset(((function_value(m.ProcLabel, (~proc)), function_value(m.FileLabel, function_value(m.FDFile, (~fd)))),)))))))))
