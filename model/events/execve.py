...
def execve(m: Machine,
           ...
           _procNewLabel: Machine.StringsItem | None) -> Event:
    ...
    _grd12 = Guard('grd12', lambda _: (not (_(42, function_value(m.ProcUser, (~proc)) != m.ROOT_USER)) or (_(43, 
    not any (True for f in (function_value(m.PathToRoot, (~parent)) | frozenset(((~parent), (~exeFile)))) if not (
    ...
    _grd13 = Guard('grd13', lambda _: (((_(44, 
    (~exeFile) in relation_domain(m.FileExecLabel))) and (_(45, (~procNewLabel) == function_value(m.FileExecLabel, (~exeFile))))) or (_(46, (~procNewLabel) == function_value(m.ProcLabel, (~proc))))))
    ...
    _act11 = Action('act11', m, 'ProcLabel', lambda: (override_relation(m.ProcLabel, frozenset((((~proc), (~procNewLabel)),)))))


    return Event("execve", _grd1, _grd2, _grd3, _grd4, _grd5, _grd6, _grd7, _grd8, _grd9, _grd10, _grd11, _grd12, _grd13, _act1, _act2, _act3, _act4, _act5, _act6, _act7, _act8, _act9, _act10, _act11)
