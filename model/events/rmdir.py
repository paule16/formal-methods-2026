...
def rmdir(m: Machine,
    ...
    _grd9 = Guard('grd9', lambda _: (not (_(40, function_value(m.ProcUser, (~proc)) != m.ROOT_USER)) or (_(41, 
    ...
    _grd10 = Guard('grd10', lambda _: (not (_(42, 
    ...
    _act13 = Action('act13', m, 'FileLabel', lambda: (subtract_domain(m.FileLabel, frozenset(((~folder),)))))
