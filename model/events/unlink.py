...
def unlink(
    ...
    _files: frozenset[Machine.FilesItem] | None,
) -> Event:
    ...
    _grd3 = Guard("grd3", lambda _: _(3, (~file) in (m.Files - m.Folders)))

    _grd4 = Guard(
        "grd4", lambda _: _(4, ((~file), ((~parent), (~name))) in m.FileParents)
    )

    _grd5 = Guard("grd5", lambda _: _(5, (~files) <= m.Files))
    ...
    _grd6 = Guard(
        ...
        lambda _: _(
            ...
            (
                len(
                    (
                        relation_image(m.FileParents, frozenset(((~file),)))
                        - frozenset((((~parent), (~name)),))
                    )
                )
                != 0
            )
    ...
    _grd7 = Guard(
        ...
        lambda _: _(
            7,
            (~files)
            in frozenset((frozenset[Machine.FilesItem](), frozenset(((~file),)))),
        ),
    )
                    ...
                    (
                        ...
                        or (
                            (
                                ...
                                and (_(25, (~parent) in relation_domain(m.MaskACL)))
                            )
                            and (
                                _(
                                    26,
                    ...
                    or (
                        (
                            (
                                ...
                                and (_(28, (~parent) not in relation_domain(m.MaskACL)))
                            )
                            and (
                                (
                                    _(
    ...
    _grd10 = Guard(
        "grd10",
        lambda _: (
            not (_(40, m.STICKY_BIT in function_value(m.DACPermissions, (~parent))))
            or (
                _(
                    41,
                    function_value(m.ProcUser, (~proc))
    ...
    _grd12 = Guard(
        "grd12",
        lambda _: (
            not (_(44, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                (not (_(45, function_value(m.ProcLabel, (~proc)) == m.STAR)))
                and (
                    (
                        (_(46, function_value(m.FileLabel, (~parent)) == m.STAR))
                        or (
                            _(
                                47,
                                function_value(m.ProcLabel, (~proc))
    ...
    _act3 = Action(
        "act3", m, "DACPermissions", lambda: subtract_domain(m.DACPermissions, (~files))
    )

    _act4 = Action("act4", m, "FileUser", lambda: subtract_domain(m.FileUser, (~files)))

    _act5 = Action(
        "act5", m, "FileGroup", lambda: subtract_domain(m.FileGroup, (~files))
    )

    _act6 = Action(
        "act6", m, "FileXattrs", lambda: subtract_domain(m.FileXattrs, (~files))
    )
    ...
    _act7 = Action(
        ...
        m,
        "UserACL",
        lambda: subtract_domain(m.UserACL, cartesian_product((~files), m.Users)),
    )
    ...
    _act8 = Action(
        ...
        m,
        "GroupACL",
        lambda: subtract_domain(m.GroupACL, cartesian_product((~files), m.Groups)),
    )

    _act9 = Action("act9", m, "MaskACL", lambda: subtract_domain(m.MaskACL, (~files)))

    _act10 = Action(
        "act10", m, "GroupObjACL", lambda: subtract_domain(m.GroupObjACL, (~files))
    )

    _act11 = Action("act11", m, "SymLinks", lambda: m.SymLinks - (~files))

    _act12 = Action(
        "act12", m, "FileLink", lambda: subtract_domain(m.FileLink, (~files))
    )

    _act13 = Action(
        "act13", m, "FileLabel", lambda: subtract_domain(m.FileLabel, (~files))
    )

    _act14 = Action(
        "act14", m, "FileExecLabel", lambda: subtract_domain(m.FileExecLabel, (~files))
    )
