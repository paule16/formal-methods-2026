...
def chmod(
    ...
    _grd3 = Guard("grd3", lambda _: _(3, (~mode) <= m.PERMISSIONS))

    _grd4 = Guard(
        "grd4",
        lambda _: (
            (_(4, function_value(m.ProcUser, (~proc)) == m.ROOT_USER))
            or (
                _(
                    5,
    ...
    _grd8 = Guard(
        "grd8",
        lambda _: (
            not (_(15, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                _(
                    16,
                    not any(
