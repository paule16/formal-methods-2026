...
def fchmodat(
    ...
    _grd7 = Guard("grd7", lambda _: _(10, (~mode) <= m.PERMISSIONS))
    ...
    _grd10 = Guard(
        ...
        lambda _: (
            not (
                not (
                    (
                        (_(14, (~file) in m.Folders))
                        or (_(15, function_value(m.ProcUser, (~proc)) == m.ROOT_USER))
                    )
                    or (
                        _(
                            16,
            ...
            or (_(17, (~perms) == ((~mode) - frozenset((m.SET_GID,)))))
        ),
    )
    ...
    _grd11 = Guard(
        ...
        lambda _: (
            not (
                (
                    (_(18, (~file) in m.Folders))
                    or (_(19, function_value(m.ProcUser, (~proc)) == m.ROOT_USER))
                )
                or (
                    _(
                        20,
    ...
    _grd12 = Guard(
        "grd12",
        lambda _: (
            not (_(22, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                _(
                    23,
                    not any(
    ...
    _act2 = Action(
        ...
        lambda: (
            (
                subtract_domain(m.MaskACL, frozenset(((~file),)))
                | frozenset(
                    (((~file), ((~mode) & frozenset((m.GREAD, m.GWRITE, m.GEXECUTE)))),)
                )
            )
            if ((~file) in relation_domain(m.MaskACL))
            else m.MaskACL
        ),
    )
    ...
    _act3 = Action(
        ...
        lambda: (
            (
                subtract_domain(m.GroupObjACL, frozenset(((~file),)))
                | frozenset(
                    (((~file), ((~mode) & frozenset((m.GREAD, m.GWRITE, m.GEXECUTE)))),)
                )
            )
            if ((~file) not in relation_domain(m.MaskACL))
            else m.GroupObjACL
        ),
    )
