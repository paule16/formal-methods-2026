...
def creat(m: Machine,
    ...
    _grd27 = Guard('grd27', lambda _: (_(73, (~flags) == frozenset((m.O_CREAT, m.O_WRONLY, m.O_TRUNC)))))

    _grd28 = Guard('grd28', lambda _: ((_(74, 
    m.O_CREAT not in (~flags))) or (_(75, m.O_DIRECTORY not in (~flags)))))
    ...
    return Event("creat", _grd1, _grd2, _grd3, _grd4, _grd5, _grd6, _grd7, _grd8, _grd9, _grd10, _grd11, _grd12, _grd13, _grd14, _grd15, _grd16, _grd17, _grd18, _grd19, _grd20, _grd21, _grd22, _grd23, _grd24, _grd25, _grd27, _grd28, _act1, _act2, _act3, _act4, _act5, _act6, _act7, _act8, _act9, _act10, _act11, _act12, _act13)
