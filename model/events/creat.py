...
def creat(
    ...
    _grd6 = Guard("grd6", lambda _: _(6, (~mode) <= m.PERMISSIONS))
    ...
    _grd10 = Guard(
        "grd10",
        lambda _: (_(10, m.O_CREAT in (~flags))) or (_(11, m.O_TMPFILE in (~flags))),
    )
    ...
    _grd13 = Guard(
        "grd13",
        lambda _: (
            not (_(21, m.O_TMPFILE in (~flags)))
            or ((_(22, m.O_WRONLY in (~flags))) or (_(23, m.O_RDWR in (~flags))))
        ),
    )

    _grd14 = Guard("grd14", lambda _: _(24, len(m.Files) < m.MAX_FILES))
    ...
    _grd16 = Guard(
        "grd16", lambda _: _(26, len(relation_range(m.ProcFDs)) < m.FILE_LIMIT)
    )

    _grd17 = Guard("grd17", lambda _: _(27, m.O_PATH not in (~flags)))
    ...
    _grd19 = Guard(
        "grd19",
        lambda _: (
            not (_(29, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                (
                    (
                        (
                        ...
                        or (
                            (
                                ...
                                and (_(45, (~parent) in relation_domain(m.MaskACL)))
                            )
                            and (
                                _(
                                    46,
                    ...
                    or (
                        (
                            (
                                ...
                                and (_(48, (~parent) not in relation_domain(m.MaskACL)))
                            )
                            and (
                                (
                                    _(
    ...
    _grd20 = Guard("grd20", lambda _: _(60, (~group) in m.Groups))

    _grd21 = Guard(
        "grd21",
        lambda _: (
            not (_(61, m.SET_GID not in function_value(m.DACPermissions, (~parent))))
            or (_(62, (~group) == function_value(m.ProcGroup, (~proc))))
        ),
    )
    ...
    _grd22 = Guard(
        "grd22",
        lambda _: (
            not (_(63, m.SET_GID in function_value(m.DACPermissions, (~parent))))
            or (_(64, (~group) == function_value(m.FileGroup, (~parent))))
        ),
    )
    ...
    _grd23 = Guard(
        "grd23",
        lambda _: _(
            65, (~perms) == ((~mode) - ((~mode) & function_value(m.ProcUmask, (~proc))))
        ),
    )
    ...
    _grd24 = Guard(
        "grd24",
        lambda _: (
            not (_(66, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                _(
                    67,
                    not any(
    ...
    _grd25 = Guard(
        "grd25",
        lambda _: (
            not (_(68, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                (not (_(69, function_value(m.ProcLabel, (~proc)) == m.STAR)))
                and (
                    (
                        (_(70, function_value(m.FileLabel, (~parent)) == m.STAR))
                        or (
                            _(
                                71,
                                function_value(m.ProcLabel, (~proc))
    ...
    _grd26 = Guard(
        ...
        lambda _: (
            (
                (
                    (_(73, (~parent) in m.TransmuteFolders))
                    and (
                        _(
                            74,
                            m.TRANSMUTE
                ...
                and (_(75, (~fileLabel) == function_value(m.FileLabel, (~parent))))
            )
            or (_(76, (~fileLabel) == function_value(m.ProcLabel, (~proc))))
        ),
    )

    _grd27 = Guard(
        "grd27",
        lambda _: _(77, (~flags) == frozenset((m.O_CREAT, m.O_WRONLY, m.O_TRUNC))),
    )
