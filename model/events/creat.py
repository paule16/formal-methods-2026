...
def creat(m: Machine,
    ...
    _grd25 = Guard('grd25', lambda _: (_(66, (~flags) == frozenset((m.O_CREAT, m.O_WRONLY, m.O_TRUNC)))))

    _grd26 = Guard('grd26', lambda _: (not (_(67, 
    function_value(m.ProcUser, (~proc)) != m.ROOT_USER)) or (_(68, 
    ...
    _grd27 = Guard('grd27', lambda _: (not (_(69, 
    function_value(m.ProcUser, (~proc)) != m.ROOT_USER)) or ((not (_(70, 
    function_value(m.ProcLabel, (~proc)) == m.STAR))) and (((_(71, 
    function_value(m.FileLabel, (~parent)) == m.STAR)) or (_(72, 
    function_value(m.ProcLabel, (~proc)) == function_value(m.FileLabel, (~parent))))) or (_(73, 
    m.WRITE in relation_image(m.SmackRules, frozenset(((function_value(m.ProcLabel, (~proc)), function_value(m.FileLabel, (~parent))),)))))))))

    _grd28 = Guard('grd28', lambda _: ((((_(74, 
    (~parent) in m.TransmuteFolders)) and (_(75, m.TRANSMUTE in relation_image(m.SmackRules, frozenset(((function_value(m.ProcLabel, (~proc)), function_value(m.FileLabel, (~parent))),)))))) and (_(76, 
    (~fileLabel) == function_value(m.FileLabel, (~parent))))) or (_(77, 
    ...
    return Event("creat", _grd1, _grd2, _grd3, _grd4, _grd5, _grd6, _grd7, _grd8, _grd9, _grd10, _grd11, _grd12, _grd13, _grd14, _grd15, _grd16, _grd17, _grd18, _grd19, _grd20, _grd21, _grd22, _grd23, _grd25, _grd26, _grd27, _grd28, _act1, _act2, _act3, _act4, _act5, _act6, _act7, _act8, _act9, _act10, _act11, _act12, _act13)
