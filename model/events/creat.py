...
def creat(
    ...
    _grd25 = Guard(
        "grd25",
        lambda _: _(66, (~flags) == frozenset((m.O_CREAT, m.O_WRONLY, m.O_TRUNC))),
    )

    _grd26 = Guard(
        "grd26",
        lambda _: (
            not (_(67, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                _(
                    68,
                    not any(
    ...
    _grd27 = Guard(
        "grd27",
        lambda _: (
            not (_(69, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                (not (_(70, function_value(m.ProcLabel, (~proc)) == m.STAR)))
                and (
                    (
                        (_(71, function_value(m.FileLabel, (~parent)) == m.STAR))
                        or (
                            _(
                                72,
                                function_value(m.ProcLabel, (~proc))
    ...
    _grd28 = Guard(
        ...
        lambda _: (
            (
                (
                    (_(74, (~parent) in m.TransmuteFolders))
                    and (
                        _(
                            75,
                            m.TRANSMUTE
                ...
                and (_(76, (~fileLabel) == function_value(m.FileLabel, (~parent))))
            )
            or (_(77, (~fileLabel) == function_value(m.ProcLabel, (~proc))))
        ),
    )
