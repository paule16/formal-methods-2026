...
def close(
    ...
    _grd3 = Guard("grd3", lambda _: _(3, (~fds) <= m.FDs))
    ...
    return Event(
        "close", _grd1, _grd2, _grd3, _grd4, _grd5, _act1, _act2, _act3, _act4, _act5
    )
