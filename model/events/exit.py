...
def exit(m: Machine,
    ...
    _act10 = Action('act10', m, 'ProcParent', lambda: (frozenset((x, y) for x in (m.Procs - frozenset((m.INIT, (~proc)))) for y in frozenset((function_value(m.ProcParent, x), m.INIT)) if (function_value(m.ProcParent, x) != (~proc) and y == function_value(m.ProcParent, x) or function_value(m.ProcParent, x) == (~proc) and y == m.INIT))))
    ...
    _act15 = Action('act15', m, 'ProcLabel', lambda: (subtract_domain(m.ProcLabel, frozenset(((~proc),)))))


    return Event("exit", _grd1, _grd2, _grd3, _act1, _act2, _act3, _act4, _act5, _act6, _act7, _act8, _act9, _act10, _act11, _act12, _act13, _act14, _act15)
