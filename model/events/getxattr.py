...
machines: dict[str, list[str]] = {
    "DAC": ["grd1", "grd2", "grd4", "grd3", "grd5", "grd6"],
    "MAC": ["grd7", "grd8"],
    "MAC_EXT": [],
}
...
def getxattr(
    ...
    _grd4 = Guard("grd4", lambda _: _(3, (~size) in NAT))

    _grd3 = Guard(
        "grd3",
        lambda _: (
            (_(4, (~name) in relation_domain(function_value(m.FileXattrs, (~file)))))
            and (
                not (_(5, (~size) > 0))
                or (
                    _(
                        ...
                        (~value)
                        == function_value(
                            function_value(m.FileXattrs, (~file)), (~name)
                        ),
                    )
                )
            )
                    ...
                    (
                        (
                            ...
                            or (
                                ...
                                and (
                                    _(20, m.GREAD in function_value(m.MaskACL, (~file)))
                                )
                            )
                        )
                        or (
                            (
                                ...
                                and (_(24, (~file) in relation_domain(m.MaskACL)))
                            )
                            and (_(25, m.GREAD in function_value(m.MaskACL, (~file))))
                        )
                    )
                    or (
                        (
                            (
                                ...
                                and (_(27, (~file) not in relation_domain(m.MaskACL)))
                            )
                            and (
                                (
                                    _(
                        ...
                        and (
                            _(30, m.GREAD in function_value(m.DACPermissions, (~file)))
                        )
                    )
                )
                or (
                    ...
                    and (_(38, m.OREAD in function_value(m.DACPermissions, (~file))))
                )
            )
        ),
    )
    ...
    _grd7 = Guard(
        "grd7",
        lambda _: (
            not (_(39, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                _(
                    40,
                    not any(
    ...
    _grd8 = Guard(
        "grd8",
        lambda _: (
            not (_(41, function_value(m.ProcUser, (~proc)) != m.ROOT_USER))
            or (
                (not (_(42, function_value(m.ProcLabel, (~proc)) == m.STAR)))
                and (
                    (
                        (
                            (
                                (_(43, function_value(m.ProcLabel, (~proc)) == m.HAT))
                                or (
                                    _(
                                        44,
                            ...
                            or (_(45, function_value(m.FileLabel, (~file)) == m.STAR))
                        )
                        or (
                            _(
                                46,
