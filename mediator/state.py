...
class MediatorState:
    ...
    def do_creat(self, path: str, file: Inode, uid: int, gid: int, perms: int):
        ...
        self.stats[file] = FileStat(
            st_uid=uid, st_gid=gid, st_mode=perms, st_nlink=1, kind="file"
        )
    ...
    def do_mkdir(self, path: str, folder: Inode, uid: int, gid: int, perms: int):
        ...
        self.stats[folder] = FileStat(
            st_uid=uid, st_gid=gid, st_mode=perms, st_nlink=1, kind="folder"
        )
